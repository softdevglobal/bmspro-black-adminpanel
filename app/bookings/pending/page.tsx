...
export default function PendingBookingsPage() {
  ...
  return <BookingsListByStatus status={["Pending", "AwaitingStaffApproval", "PartiallyApproved", "StaffRejected"]} title="Booking Requests" showStaffColumn={false} showExportButton />;
}
